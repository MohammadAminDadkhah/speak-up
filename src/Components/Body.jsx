const Body = () => {
    return (
        <div className="flex container mx-auto md:flex-row  font-body" dir="rtl">
            <img className="md:flex hidden" src={'src/assets/Vector(1).svg'} alt=""/>

            <div className="lg:flex m-8 lg:mt-10 mt-24">
                <div className="flex  basis-1/2">
                    ...
                    <div className="flex flex-col mx-auto my-auto md:items-start items-center lg:basis-4/5">
                        ...
                        <div>
                            <button className="md:bg-[#0052CC] bg-[#DDEBFF] border-[#0052CC] border-2 md:outline-none rounded p-2 px-5">
