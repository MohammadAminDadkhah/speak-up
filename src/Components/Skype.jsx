    ...
    return (
        <div className="font-body flex flex-col items-center mt-9 md:mx-40" dir="rtl">
            ...
            <div className="flex flex-col mt-8 md:mt-12 margin">
                <h1 className="text-center text-xl sm:text-2xl font-semibold">ایجاد یک محیط 100 درصد انگلیسی و یادگیری زبان به طبیعی ترین روش</h1>

                <p className="mt-5 text-xs text-center mb-5 sm:text-[1rem] sm:leading-6">
                ...
                <div>
                    ...
                    <div className="flex md:flex-row flex-col md:leading-6">
                        <div className="flex flex-col md:basis-2/3 my-auto order-1 md:order-2">
                            <p className="text-center text-[1rem] mt-10">
                                اساس آموزش ما در
                            <span className="underline font-bold">
                                کلاس های آنلاین
                            </span> است اما زبان <span className="font-bold">آموزان تهرانی</span> می‌توانند در صورت تمایل در کلاس های حضوری نیز ثبت نام
                                کنند
                            </p>
